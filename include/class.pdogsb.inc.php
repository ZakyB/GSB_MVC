...
*/
	public function getLesIdFrais(){
        ...
        public static function getLesMoisFicheFrais() {
...
*/
	public function getLesMoisDisponibles($idVisiteur){
        ...
        public function getLesVisiteurs($idcomptable) {
            $req="SELECT id,nom,prenom,idComptable FROM visiteur where idComptable='".$idcomptable."'";
        ...
        public function getLesMoisDuVisiteur($idVisiteur,$etat) {
            $req="SELECT DISTINCT mois FROM fichefrais WHERE idVisiteur='".$idVisiteur."' AND idEtat='".$etat."' ";
